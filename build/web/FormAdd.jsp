                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-md-16">
                                <div class="white_shd full margin_bottom_30">
                                    ...
                                    <h2 style="margin-left: 20px ; margin-top: 50px;margin-bottom: -40px">Thêm Nhân Viên</h2>
                                    <form action="InsertEmployee" method="post" enctype="multipart/form-data">
                                        <div class="table_section padding_infor_info">
                                            <br/><br/>  <br/>  <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="id" name="id" required placeholder="Nhập họ tên">
                                            </div>
                                            ...
                                            <button type="submit" value="submit" class="btn btn-primary">Thêm Nhân Viên</button>
