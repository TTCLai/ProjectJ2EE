    ...
    <head>
        ...
        <style>
            ...
            .btnExitAdmin {
                ...
                color: white;
                /*                padding: 15px 30px;  Bigger padding for visibility 
                ...
                padding: 0;      /* Remove padding to maintain circle */
                border: none;
            }
                            ...
                            <c:if test="${role=='admin'}">
                                ...
                                <li>
                                    ...
                                    <ul class="collapse list-unstyled" id="element">
                                        ...
                                        <li>
                                            <a href="">><span>Danh sách nhân viên</span></a>
                                        </li>
                                        <li>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-md-16">
                                <div class="white_shd full margin_bottom_30">
                                    ...
                                    <form id="deleteForm" action="${pageContext.request.contextPath}/XoaNhanVien?employeeid=${employee.id}">
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:forEach var="employee" items="${listE}">
                                                            <tr>
    <!--                                                            <td><input type="checkbox" name="employeeid" value="${employee.employeeid}"></td>-->
