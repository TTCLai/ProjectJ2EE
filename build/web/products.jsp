<%-- 
    Document   : products
    Created on : Oct 21, 2024, 12:11:21 PM
    Author     : LENOVO
--%>

<%-- 
    Document   : category
    Created on : Oct 20, 2024, 9:58:22 PM
    Author     : LENOVO
--%>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-md-16">
                                <div class="white_shd full margin_bottom_30">
                                    ...
                                    <form action="${pageContext.request.contextPath}/TaiSanPham" method="GET">
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:forEach var="product" items="${listP}">
                                                            <tr>
                                                                <td>
                                                                    <img width="70" height=70" src="${pageContext.request.contextPath}/ThemHinhSanPham?productID=${product.productid}" class="profile-img">
                                                                </td>
...
<!--                                                                <td style="float: left">
                                                                    <form method="get" action="${pageContext.request.contextPath}/SuaNhanVien">
                                                                        <input type="hidden" name="employeeID" value="${employee.employeeid}">
                                                                        <button class="btnEdit1">
                                                                            Sửa
                                                                        </button>
                                                                    </form>
                                                                    <form style="float: right" action="${pageContext.request.contextPath}/XoaSanPham" method="get">
                                                                ...
                                                                <td style="float: left">
                                                                    <!-- comment <form method="post" action="${pageContext.request.contextPath}/CapNhanNhanVien">
                                                                        <input type="hidden" name="employeeid" value="${employee.employeeid}">
                                                                        <button class="btnEdit1">
                                                                            Sửa
                                                                        </button>
