<%-- 
    Document   : admin
    Created on : Sep 23, 2024, 2:53:45 PM
    Author     : LENOVO
--%>
            ...
            <div class="inner_container">
                            ...
                            <c:if test="${role=='admin'}">
                                ...
                                <li>
                                    ...
                                    <ul class="collapse list-unstyled" id="element">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/TaiTaiKhoan">Tài khoản nhân viên</a>
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/TaiSanPham"><i class="fa fa-cubes"></i>
                ...
                <div id="content">
                    ...
                    <div>
                        ...
                        <button class="btn-admin btnDelAdmin">
                            <a href="FormAdd.html">
