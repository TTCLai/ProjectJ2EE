<%-- 
    Document   : index
    Created on : Sep 23, 2024, 2:53:27 PM
    Author     : LENOVO
--%>
                ...
                <nav id="sidebar">
                    ...
                    <div class="sidebar_blog_2">
                        ...
                        <ul class="list-unstyled components">
                            ...
                            <li>
                                <a href="admin.html"><i class="fa fa-user "></i><span>Admin</span></a>
                            </li>
                            <li>
                                ...
                                <ul class="collapse list-unstyled" id="element">
                                    <li>
                                        <a href="general_elements.html">> <span>Employees acccount</span></a>
                                    </li>
                                    <li>
                                        <a href="media_gallery.html">> <span>Employee list</span></a>
                                    </li>
                            ...
                            <li>
                                <a href="#apps" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                                    ...
                                    <span>Store manager</span></a>
                                <ul class="collapse list-unstyled" id="apps">
                                    <li>
                                        <a href="email.html">> <span>Warehouse statistics</span></a>
                                    </li>
                                    <li>
                                        <a href="calendar.html">> <span>Supliers</span></a>
                                    </li>
                            ...
                            <li>
                                <a href="map.html"><i class="fa fa-square "></i> <span>Customers</span></a>
                            </li>
                                                        ...
                                                        <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                                            ...
                                                            <div class="carousel-inner">
                                                                <div class="item carousel-item active">
                                                                    <div class="img-box">
                                                                        <img src="images/layout_img/user_img.jpg" alt="" />
                                                                    </div>
                                                                    <p class="testimonial">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="progress_bar">
                                                        <!-- Skill Bars -->
                                                        <span class="skill" style="width: 73%">Facebook
                                                            <span class="info_valume">73%</span></span>
                                                        ...
                                                        <span class="skill" style="width: 62%">Twitter
                                                            <span class="info_valume">62%</span></span>
                                                        <div class="progress skill-bar">
                                                            <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar"
                                                                 aria-valuenow="62" aria-valuemin="0" aria-valuemax="100" style="width: 62%"></div>
                                                        </div>
                                                        <span class="skill" style="width: 54%">Instagram
                                                            <span class="info_valume">54%</span></span>
                                                        <div class="progress skill-bar">
                                                            <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar"
                                                                 aria-valuenow="54" aria-valuemin="0" aria-valuemax="100" style="width: 54%"></div>
                                                        </div>
                                                        <span class="skill" style="width: 82%">Google plus
                                                            <span class="info_valume">82%</span></span>
                                                        <div class="progress skill-bar">
                                                            <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar"
                                                                 aria-valuenow="82" aria-valuemin="0" aria-valuemax="100" style="width: 82%"></div>
                                                        </div>
                                                        <span class="skill" style="width: 48%">Other <span class="info_valume">48%</span></span>
                                                        <div class="progress skill-bar">
                                                            <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar"
                                                                 aria-valuenow="48" aria-valuemin="0" aria-valuemax="100" style="width: 48%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 margin_bottom_30">
                                    <div class="dash_blog">
                                        <div class="dash_blog_inner">
                                            <div class="dash_head">
                                                <h3>
                                                    <span><i class="fa fa-calendar"></i> 6 July 2018</span><span class="plus_green_bt"><a
                                                            href="#">+</a></span>
                                                </h3>
                                            </div>
                                            <div class="list_cont">
                                            ...
                                            <div class="task_list_main">
                                                <ul class="task_list">
                                                    <li>
                                                        <a href="#">Meeting about plan for Admin Template 2018</a><br /><strong>10:00 AM</strong>
                                                    </li>
                                                    <li>
                                                        <a href="#">Create new task for Dashboard</a><br /><strong>10:00 AM</strong>
                                                    </li>
                                                    <li>
                                                        <a href="#">Meeting about plan for Admin Template 2018</a><br /><strong>11:00 AM</strong>
                                                    </li>
                                                    <li>
                                                        <a href="#">Create new task for Dashboard</a><br /><strong>10:00 AM</strong>
                                                    </li>
                                                    <li>
                                                        <a href="#">Meeting about plan for Admin Template 2018</a><br /><strong>02:00 PM</strong>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="read_more">
                                ...
                                <div class="col-md-6">
                                    <div class="dash_blog">
                                        <div class="dash_blog_inner">
                                            <div class="dash_head">
                                                <h3>
                                                    <span><i class="fa fa-comments-o"></i> Updates</span><span class="plus_green_bt"><a
                                                            href="#">+</a></span>
                                                </h3>
                                            </div>
                                            <div class="list_cont">
