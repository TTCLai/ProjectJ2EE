...
<html lang="en">
    ...
    <div style" margin-top: 25px;margin-bottom: 25px; " class="container">
        <div style="background-color: white; width:100%;" class="container mt-5">
            <div>
                <h3 class="fw-bold mb-3">Thêm Nhân Viên</h3>
            ...
            <form action="ThemNV" method="post" enctype="multipart/form-data" >
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="img" class="form-label">Chọn Hình Ảnh Nhân Viên</label>
                ...
                <button style="margin-bottom: 20px;" type="submit" value="submit" class="btn btn-primary">Thêm Nhân Viên</button>
