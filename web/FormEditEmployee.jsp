...
<html lang="en">
    ...
    <div style" margin-top: 25px;margin-bottom: 25px; " class="container">
        <div style="background-color: white; width:100%;" class="container mt-5">
            <div>
                <h3 class="fw-bold mb-3">Chỉnh Sửa Nhân Viên</h3>
                <h5 class="op-7 mb-2">Pulo</h6>
            </div>
            <br>

            <form action="${pageContext.request.contextPath}/CapNhanNhanVien" method="post" enctype="multipart/form-data" >
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="fullname" class="form-label">Họ Tên</label>
                            <input type="text" class="form-control" value="${listED.fullname}" name="fullname" id="fullname" required>
                        </div>
<!--                        <div class="mb-3">
                            <label for="password" class="form-label">Mật Khẩu(Bỏ qua nếu không thay đổi)</label>
                            <input type="password" class="form-control" id="password" name="password" required>
                        </div>-->
                        <div class="mb-3">
                            <label for="address" class="form-label">Địa Chỉ</label>
                            <input type="text" class="form-control" id="address" value="${listED.address}" name=address required>
                        </div>
                         <div class="mb-3">
                            <label for="phonenumber" class="form-label">Số Điện Thoại</label>
                            <input type="text" class="form-control" id="phonenumber" value="${listED.phonenumber}" name="phonenumber" required>
                        </div>
                        </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="img" class="form-label">Hình Ảnh Nhân Viên</label>
                            <input type="file" class="form-control" id="img" value="${listED.img}" name="img" accept="image/*" onchange="previewImage(event)">
                        </div>
                ...
                <button style="margin-bottom: 20px;" type="submit" value="submit" class="btn btn-primary">Cập Nhật</button>
<!--                <a style="float: right;" href="employeedetails.jsp">Quay lại trang</a>-->
                <button style="margin-bottom: 20px;" type="button"  class="btn btn-primary"onclick="window.location.href = 'TaiNhanVien';">Đóng</button>
