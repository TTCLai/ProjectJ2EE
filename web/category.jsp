        ...
        <div class="full_container">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-md-16">
                                <div class="white_shd full margin_bottom_30">
                                    ...
                                    <form action="${pageContext.request.contextPath}/TaiLoaiSanPham" method="GET">
                                                        ...
                                                        <c:forEach var="category" items="${listC}">
                                                            <tr>
                                                                ...
                                                                <td style="float: left">
                                                                    ...
                                                                    <form style="float: right" action="${pageContext.request.contextPath}/XoaLoaiSanPham" method="get">
            ...
            <script>
                            function confirmDelete() {
                                ...
                                if (confirm('Bạn có chắc chắn là xóa loại sản phẩm này?')) {
